import { BREAKPOINT, BREAKPOINTS, DEFAULT_BREAKPOINTS, BreakPoint } from '@angular/flex-layout';
...
const CUSTOM_BREAKPOINTS = DEFAULT_BREAKPOINTS.map( it => updateMediaQuery(it) );
